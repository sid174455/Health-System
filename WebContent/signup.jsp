...
<table border="0" style="padding:50px" width="90%" cellspacing="10">
		<tr><td></td><td ><h1><span class="dark_blue"> Sign Up Panel for Patient</span></h1></td></tr>
		...
		<tr>
			...
			<td >
				<input  tabindex="1"  type="text"  id="name" name="name" class="text" required/>
				<input  type="hidden"  id="role" name="role" value="patient" class="text" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input  tabindex="4" type="text"  id="age" name="age" class="text" style="width:30px" required/> yrs</td>
		</tr>
		<tr>
			<td   style="padding-left:50px"><h1><span class="dark_blue">Email ID *</span></h1></td>
			<td><input  tabindex="5" type="email" id="email" name="email" class="text"  style="width:50%" required/></td>
		</tr>
		<tr>
			<td   style="padding-left:50px"><h1><span class="dark_blue">Mobile No *</span></h1></td>
			<td><input  tabindex="6" type="text"  id="mobile" name="mobile" class="text"  style="width:50%" required/></td>
		</tr>
		<tr>
