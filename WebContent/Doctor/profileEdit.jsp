				...
				<td>
					<div class="box_content1">
						...
						<div class="box_text_content">
							<form name="registerForm"  onsubmit="return validate();" method="post" action="../updatedprofile" >
							...
							%>	
									<tr>
										...
										<td ><input autocomplete="off" value="<%=AES.decrypt(rs.getString("user_name"),keyname) %>" tabindex="1" type="text"  id="name" name="name" class="text" /></td>
									</tr>
									<tr>
										<td   style="padding-left:50px;vertical-align:top"><h1><span class="dark_blue">Address *</span></h1></td>
										<td><textarea rows="5" tabindex="2"   id="address" name="address" class="text" /><%=AES.decrypt(rs.getString("user_address"),keyname) %></textarea></td>
									</tr>
						
									<tr>
										<td   style="padding-left:50px"><h1><span class="dark_blue">Age *</span></h1></td>
										<td><input autocomplete="off" tabindex="4" type="text" value="<%=AES.decrypt(rs.getString("user_age"),keyname) %>" id="age" name="age" class="text" style="width:30px" /> yrs</td>
									</tr>
									<tr>
										<td   style="padding-left:50px"><h1><span class="dark_blue">Email ID</span></h1></td>
										<td><input autocomplete="off" tabindex="5" type="text" value="<%=AES.decrypt(rs.getString("user_email"),keyname) %>" onblur="chkEmail()"  id="email" name="email" class="text"  style="width:50%" /></td>
									</tr>
									<tr>
										<td   style="padding-left:50px"><h1><span class="dark_blue">Mobile No *</span></h1></td>
										<td><input autocomplete="off" tabindex="6" type="text"  value="<%=AES.decrypt(rs.getString("user_mobile"),keyname) %>" id="mobile" name="mobile" class="text"  style="width:50%" /></td>
									</tr>
									<tr>
										<td   style="padding-left:50px"><h1><span class="dark_blue">Qualification *</span></h1></td>
										<td><input autocomplete="off" tabindex="6" type="text"  value="<%=AES.decrypt(rs.getString("user_qualification"),keyname) %>" id="quali" name="quali" class="text"  style="width:50%" /></td>
									</tr>									
									<tr>
										<td   style="padding-left:50px"><h1><span class="dark_blue">Username *</span></h1></td>
										<td><input autocomplete="off" tabindex="8" type="text" value="<%=AES.decrypt_use(rs.getString("user_username")) %>"  id="username" name="username" class="text"  style="width:50%" /></td>
									</tr>
									<tr>
										<td   style="padding-left:50px"><h1><span class="dark_blue">Password *</span></h1></td>
										<td><input autocomplete="off" tabindex="9" type="password"  value="<%=AES.decrypt_use(rs.getString("user_password")) %>" id="password" name="password" class="text"  style="width:50%" /></td>
									</tr>
									<tr>
